...
MANUAL_OFFICIAL_URL_BY_DETAIL_URL = {
    "https://dayseechat.com/subsidy/grant-431/": "https://www.ndc.gov.tw/nc_14813_40016",
    "https://dayseechat.com/subsidy/grant-428/": "https://www.sw.ntpc.gov.tw/uploaddowndoc?dis=anounce&file=anounce%2F202604081737360.pdf&filedisplay=%E9%99%84%E4%BB%B61_115%E5%B9%B4%E5%BA%A6%E5%85%92%E5%B0%91%E6%9C%AA%E4%BE%86%E6%95%99%E8%82%B2%E7%99%BC%E5%B1%95%E5%B8%B3%E6%88%B6%E5%AE%B6%E6%88%B6%E8%A8%AA%E8%A6%96%E8%A8%88%E7%95%AB%E6%9B%B8.pdf&flag=doc",
    "https://dayseechat.com/subsidy/grant-420/": "https://www.economic.ntpc.gov.tw/Api/News/Page?id=7127",
    "https://dayseechat.com/subsidy/grant-410/": "https://www.economic.ntpc.gov.tw/Api/News/Page?id=7127",
    "https://dayseechat.com/subsidy/grant-414/": "https://www.culture.ntpc.gov.tw/xmdoc/cont?sid=0Q086534824036260424&xsmsid=0g244829470294446149",
    "https://dayseechat.com/subsidy/grant-399/": "https://youthhsinchu.hccg.gov.tw/youth/app/artwebsite?id=64&module=artwebsite&serno=null",
    "https://dayseechat.com/subsidy/grant-375/": "https://www.oac.gov.tw/ch/home.jsp?dataserno=202602230001&id=67&mcustomize=bulletin_view.jsp&parentpath=0%2C6",
}
...
class GrantCrawler:
    ...
    async def resolve_organizer_urls(self, row: GrantRow) -> GrantRow:
        ...
        manual_url = MANUAL_OFFICIAL_URL_BY_DETAIL_URL.get(row.detail_url)
        if manual_url:
            verified_manual, manual_domain = verify_url(manual_url)
            final_url = verified_manual or manual_url
            final_domain = manual_domain or get_domain(manual_url)
            row.organizer_search_query = row.title
            row.organizer_site_url = final_url
            row.organizer_site_domain = final_domain
            row.official_organizer_site_url = final_url
            row.official_organizer_domain = final_domain
            row.official_url_status = "manual_verified_override"
            return row
